...
<body>
    <form action="{{route('response.update', $reportId)}}" method="POST" style="width: 500px; margin: 50px auto; display: block;">
        ...
        {{-- cek apakah data $report yang dari compact itu adaan, maksudnya adaan tuh where di db responses nya ada data yang punya report_id sama kata yang dikirim ke path (report_id) --}}
        @if ($report)    
